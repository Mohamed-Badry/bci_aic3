...
# model config
model:
  name: "DeepConvNet"      # {EEGNet | DeepConvNet | ShallowConvNet | ATCNet | SSVEPformer} 
  task_type: "MI"          # {MI | SSVEP}
  num_classes: 2
  num_channels: 8
  sequence_length: 2250
  n_csp_components: 6      # Number of CSP components to keep (usually 4-8)
...
preprocessing:
  ...
  # ICA parameters
  ica_n_components: 8      # Use all channels for ICA
  ica_random_state: 42
